...
env = environ.FileAwareEnv(
    ...
    DD_CELERY_CRON_PRIORITY_TAGS_FILTER=(str, ""),
    DD_CELERY_CRON_PRIORITY_EXCLUDED_TAGS_FILTER=(str, ""),
    ...
    DD_CELERY_CRON_STATUS_FINDINGS_PRIORIZATION=(bool, False),
    ...
    DD_PATH_FOLDER_RISK_SCORE=(str, ""),
    DD_CVE_CUTOFF = (str, "CVE-2002-1976"),
    # Verify request
    DD_VERIFY_REQUEST_ENABLED=(bool, False),
)
...
PATH_FOLDER_RISK_SCORE = env("DD_PATH_FOLDER_RISK_SCORE")
CVE_CUTOFF = env("DD_CVE_CUTOFF")
# Verify request
VERIFY_REQUEST_ENABLED = env("DD_VERIFY_REQUEST_ENABLED")
...
DJANGO_MIDDLEWARE_CLASSES = [
    ...
    "dojo.middleware.UserRoleCookieMiddleware",
...
DEDUPLICATION_ALGORITHM_PER_PARSER = {
    ...
    "Tenable Scan": DEDUPE_ALGO_UNIQUE_ID_FROM_TOOL,
...
CELERY_CRON_PRIORITY_TAGS_FILTER = env("DD_CELERY_CRON_PRIORITY_TAGS_FILTER")
CELERY_CRON_PRIORITY_EXCLUDED_TAGS_FILTER = env("DD_CELERY_CRON_PRIORITY_EXCLUDED_TAGS_FILTER")
...
PROVIDER_CORE_ENGINE = env("DD_PROVIDER_CORE_ENGINE")
# Abuse Control
